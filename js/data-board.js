...
const SQUARES = (() => {
  ...
  row(150, 170, 1180, 22, 1.6, 0.3, [
    ...
    { t: "branch", label: "進路選択", text: "人生最初の分かれ道！大学へ行く？すぐ働く？",
      routes: [
        { label: "🎓 大学ルート（学費¥3,000,000／高給のエリート職業ゾーンへ）", next: 0 },
  ...
  row(300, 1180, 340, 20, 1.2, 2.1, [
    Object.assign(M(-3000000, "大学入学", "大学に合格！学費を支払う（通過でも支払い）"), { pass: true }),
  ...
  sq[20].next = [32];
  sq[31].next = [32];
  sq[51].next = [52, 66]; sq[51].routes[0].next = 52; sq[51].routes[1].next = 66;
  sq[65].next = [80];
  sq[79].next = [80];
